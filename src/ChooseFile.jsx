       ...
       self.setState({isDataLoading:true})
        ...
        if (f) {
          ...
          r.onload = function(e) { 
              ...
              self.setState({dataSet:dataArray,isDataLoading:false});
          }
          r.readAsText(f);
        } else { 
           ...
           <div className={classes.chooseFile}>
             ...
             <div>
                 {this.state.isDataLoading ?
                     <div className={classes.progressView}>{"Importing Data from CSV"}<CircularProgress color={"secondary"} disableShrink/></div>
